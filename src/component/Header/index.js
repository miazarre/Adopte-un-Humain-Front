    ...
    <div className="header__container">
      <div className="header__menu">
        <Menu>
          ...
          <Link to="/" className="item-link item-link--text">
            {" "}
            Accueil
          </Link>
          {isLogged ? (
            <>
              <Link
                to="/trombinoscope"
                className="bm-item item-link item-link--text"
              >
                {" "}
                Trombinoscope
              </Link>
              ...
              <Link to="/profil" className="bm-item item-link item-link--text">
                {" "}
                Profil
              </Link>
              <Link
              ...
              {user.role_id == 3 && (
                <Link to="/board" className="bm-item item-link item-link--text">
                  {" "}
                  Tableau de Bord
                </Link>
              )}
              ...
              <button onClick={handleDeconnexion} className="item-link--deco">
