...
const PatchAnimal = ({ isLogged, user }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`${baseUrl}/animal/${id}`, formData, {
        headers: {
        ...
        {isLogged ? (
          <>
            <div className="preference__actual-profil">
              ...
              <p className="preference__actual-profil--title">
                Tags obligatoires
              </p>
