...
const AnimalProfil = ({ user, isLogged, favorites, toggleFavorite }) => {
  ...
  const resolveMatching = (data) => {
    ...
    setMatching({
      ...matching,
      count: animalFilledTagCount,
      animalTag: animalTagCount,
      pourcentage: pourcentage,
      pourcentageDone: pourcentageDone,
    });
  };
  ...
  const handleFormSubmit = async () => {
    ...
    if (
      form.form1.length < 10 ||
      form.form2.length < 10 ||
  ...
  return (
    <>
      <div className="animal-profil__container">
        {isLogged ? (
          <>
            <div className="animal-profil__back">
              <span>
                <TiArrowBack onClick={(e) => navigate(-1)} size={"50px"} />
              </span>
            </div>
                ...
                <Slider {...settings}>
                  ...
                  {animal.photo2 && (
                    <div>
                      <div
                        style={{
                          backgroundImage: `url(${baseUrl}/images/animal/${animal.photo2})`,
                        }}
                        className="animal-profil__details--image"
                      ></div>
                    </div>
                  ...
                  {animal.photo3 && (
                    <div>
                      <div
                        style={{
                          backgroundImage: `url(${baseUrl}/images/animal/${animal.photo3})`,
                        }}
                        className="animal-profil__details--image"
                      ></div>
                    </div>
                  ...
                  {animal.photo4 && (
                    <div>
                      <div
                        style={{
                          backgroundImage: `url(${baseUrl}/images/animal/${animal.photo4})`,
                        }}
                        className="animal-profil__details--image"
                      ></div>
                    </div>
              ...
              <div className="animal-profil__details--matching">
                  ...
                  {matching.pourcentage != 0 && (
                    <PieChart
                      ...
                      data={[
                        {
                          title: "Match",
                          value: matching.pourcentageDone,
                          color: "#70C1B3",
                        },
                        {
                          title: "No Match",
                          value: matching.pourcentage,
                          color: "#247BA0",
                        },
                      ]}
                      radius={40}
                  ...
                  {data.map((tag) => {
                    if (tag.match_count == "1") {
                      return (
                        <span
                          key={tag.tag_name}
                          className="animal-profil__details--tag-match"
                        >
                          {tag.tag_name}
                        </span>
                      );
                ...
                <div>
                  ...
                  {data.map((tag) => {
                    if (
                      tag.match_count == "0" &&
                      tag.statut.includes("animal")
                    ) {
                      return (
                        <span
                          key={tag.tag_name}
                          className="animal-profil__details--tag-nomatch"
                        >
                          {tag.tag_name}
                        </span>
                      );
            ...
            <div className="animal-profil__description">
              <div className="animal-profil__title-container">
                <h1 className="animal-profil__title-container--name">
                  {animal.name}
                </h1>
                <span className="animal-profil__title-container--dot"></span>
                <p className="animal-profil__title-container--points">
                  {matching.count} point{matching.count > 1 ? "s" : ""} commun
                  {matching.count > 1 ? "s" : ""}
                </p>
              </div>
              <div
                className="animal-profil__title-container--fav"
                onClick={(e) => toggleFavorite(animal.id)}
              >
                {favorites.includes(animal.id) ? (
                  <div className="animal-profil__title-container--fav animal-profil__title-container--fav-added">
                    <BsSuitHeartFill className="icon" size={"15px"} /> Retirer
                    des coups de coeur
                  </div>
                ) : (
                  <div className="animal-profil__title-container--fav animal-profil__title-container--fav-not-added">
                    <BsSuitHeart className="icon" size={"15px"} /> Ajouter aux
                    coups de coeur
                  </div>
                )}
              </div>
              ...
              {isContactingAnimal === "yes" && (
                <>
                  <div className="animal-profil__contact">
                    {errorMessage != "" && (
                      <p className="animal-profil__contact--errorMessage">
                        {errorMessage}{" "}
                        <RxCrossCircled
                          size="30px"
                          className="animal-profil__contact--errorMessage--cross"
                    ...
                    <div className="animal-profil__contact--container">
                      <textarea
                        ...
                        className="animal-profil__contact--textarea"
                        rows="6"
                        cols="70"
                        placeholder="Première partie"
                      ></textarea>
                      <div className="animal-profil__contact--exemple">
                        <p className="animal-profil__contact--exemple--title">
                          Introduction
                        </p>
                        Bonjour {animal.name} ! Je suis tellement heureux de te
                        rencontrer. Tu as l'air si mignon et j'aimerais beaucoup
                        t'offrir un foyer aimant.
                      </div>
                    </div>
                    <div className="animal-profil__contact--container">
                      <textarea
                      ...
                      <div className="animal-profil__contact--exemple">
                        ...
                        Je suis {user.firstname} et je suis prêt à tout faire
                        pour que tu sois heureux. Pour le moment je n'ai aucun
                        animal chez moi, et je suis disponible très souvent.
                      </div>
                    </div>
                    <div className="animal-profil__contact--container">
                      <textarea
                        ...
                        rows="6"
                        cols="70"
                        placeholder="Troisième partie"
                      ></textarea>
                      <div className="animal-profil__contact--exemple">
                        <p className="animal-profil__contact--exemple--title">
                          Conclusion
                        </p>
                        Je suis impatient d'en savoir plus sur toi - ce que tu
                        aimes manger, tes jeux préférés et tout ce qui te rend
                        heureux. J'espère que nous pourrons bientôt nous
                        rencontrer en personne et commencer une belle aventure
                        ensemble. <br /> Avec affection, <br />
                        {user.firstname}
                      </div>
                    </div>
                    ...
                    <div className="animal-profil__button--container">
                      <p
                        className="animal-profil__button"
                        onClick={handleFormSubmit}
                      >
                        <span>Envoyer</span>
                      </p>
                      <p
                        className="animal-profil__button--cross"
                        onClick={(e) => setIsContactinganimal("no")}
                      >
                        <span>X</span>
                      </p>
                    </div>
              ...
              {isContactingAnimal === "no" && (
                <>
                  ...
                  <p
                    className="animal-profil__description--button"
                    onClick={(e) => setIsContactinganimal("yes")}
                  >
                    <span>Écrire à {animal.name}</span>
                  </p>
                </>
              )}
                ...
                <>
                  <div>
                    <p className="animal-profil__sending-message">
                      <RxCrossCircled
                        size="20px"
                        className="animal-profil__sending-message--cross"
                        onClick={(e) => setIsContactinganimal("no")}
                      />
                      Votre demande d'adoption à bien été prise en compte. Notre
                      staff vous recontactera rapidement, assurez-vous que vos
                      coordonnées soient à jour sur votre{" "}
                      <Link
                        to="/profil"
                        className="animal-profil__sending-message--link"
                      >
                        Profil
                      </Link>
                      .
