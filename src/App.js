  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/login"
          element={<LoginForm setUser={setUser} setIsLogged={setIsLogged} />}
        />
        <Route
          path="/signin"
          element={<SigninForm setUser={setUser} setIsLogged={setIsLogged} />}
        />
        <Route
          path="/trombinoscope"
          element={
        ...
        <Route
          path="/preferences"
          element={<Preferences user={user} isLogged={isLogged} />}
        />
        <Route
          path="/board"
          element={<Board user={user} isLogged={isLogged} />}
        />
        <Route
          path="/users"
          element={<Users user={user} isLogged={isLogged} />}
        />
        <Route
          path="/animals"
          element={<Animals user={user} isLogged={isLogged} />}
        />
        <Route
          path="/filtres"
          element={<Filtres user={user} isLogged={isLogged} />}
        />
        <Route
          path="/animals/addanimal"
          element={<AddAnimal user={user} isLogged={isLogged} />}
        />
        <Route
          path="/animals/patchanimal/:id"
          element={<PatchAnimal user={user} isLogged={isLogged} />}
        />
        <Route
          path="/adoptions"
          element={<Adoptions user={user} isLogged={isLogged} />}
        />
        <Route
          path="/adoptions/:id"
          element={<AdoptionsDetail user={user} isLogged={isLogged} />}
        />
