...
const Filtres = () => {
  ...
  const handleDeleteTag = async () => {
    ...
    try {
      const response = await axios.delete(`${baseUrl}/tag/${tagToDelete}`, {
        headers: { Authorization: `Bearer ${newToken}` },
      });
  ...
  const handleAddTag = async () => {
    ...
    try {
      const response = await axios.post(`${baseUrl}/tag`, newTag, {
        headers: { Authorization: `Bearer ${newToken}` },
      });
      console.log(response.data);
      getTags();
                ...
                <div className="tags-page__left-part--add--toggle">
                  ...
                  <label className="tags-page__left-part--add--toggle-button">
                    <input
                      ...
                      onChange={(event) =>
                        setForm({ ...form, eliminatoire: event.target.checked })
                      }
                    />
