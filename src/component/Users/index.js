        ...
        <div className="users_container-header">
          <div className="users_container-header--search">
            <form className="users_container-form">
              ...
              <input
                className="users_container-form__input"
          ...
          <Link to="/board">
            <button className="users_container--linkToBoard">
        ...
        <table className="users_container-title-table">
          ...
          {filteredUser.length
            ? filteredUser.map((user) => (
                <User key={user.id} {...user} fetchData={fetchData} />
              ))
            : data.map((user) => (
                <User key={user.id} {...user} fetchData={fetchData} />
              ))}
