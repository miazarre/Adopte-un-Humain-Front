            ...
            <div className="adoptions_container-header">
              <div className="adoptions_container-header--search">
                <form className="adoptions_container-form">
                  ...
                  <input
                    className="adoptions_container-form__input"
                    placeholder="Rechercher un animal"
                    required=""
                    type="text"
                  />
                  <button
                    className="adoptions_container-form__reset"
                    type="reset"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Link to="/board">
                <p className="adoptions_container--linkToBoard">
                  <span>Retour au Tableau de Bord</span>
                </p>
              </Link>
            </div>
            {message != "" && (
              <p className="adoptions_container--message">
                {message} <BsXCircleFill onClick={(e) => setMessage("")} />
              </p>
            )}
